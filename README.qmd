...
The following three code snippets display Differences-in-Differences (DiD) regressions that are utilized to assess the level of causality between cobalt mines and the mean number of active conflicts.
